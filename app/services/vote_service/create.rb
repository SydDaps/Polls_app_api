module VoteService
    class Create < BaseService
        ...
        def call
          ...
          raise Exceptions::NotUniqueRecord.message("Voted already") if @voter.has_voted(@poll.id)
          ...
          onboarding = @voter.onboardings.where(poll_id: @poll.id)&.first
          onboarding.update!(has_voted: true)
        end
    end
end